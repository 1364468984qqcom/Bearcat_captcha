...
if DATA_ENHANCEMENT:
    ...
    train_lable = Image_Processing.extraction_class_one_hot_lable(train_image)
else:
    train_image = Image_Processing.extraction_image(train_path)
    random.shuffle(train_image)
    train_lable = Image_Processing.extraction_class_one_hot_lable(train_image)

Image_Processing.save_n_class(train_image)
validation_image = Image_Processing.extraction_image(validation_path)
validation_lable = Image_Processing.extraction_class_one_hot_lable(validation_image)

test_image = Image_Processing.extraction_image(test_path)
test_lable = Image_Processing.extraction_class_one_hot_lable(test_image)
